...
public class EID implements Anti_Pattern {
    ...
    private Optional<OWLDisjointClassesAxiom> findInjectableDisjointClassesAxioms(OWLOntology ontology){
        List<OWLEquivalentClassesAxiom> equivalentClassesAxiomList = ontology.getAxioms(AxiomType.EQUIVALENT_CLASSES).stream().collect(Collectors.toList());
    ...
    private Optional<OWLEquivalentClassesAxiom> findInjectableEquivalentClassesAxiom(OWLOntology ontology){
        List<OWLDisjointClassesAxiom> disjointClassesAxiomList = ontology.getAxioms(AxiomType.DISJOINT_CLASSES).stream().collect(Collectors.toList());
