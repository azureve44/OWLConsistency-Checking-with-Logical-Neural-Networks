...
class tokenizer_filter():
    def __init__(self):
        ...
        self.tokenizer = T5Tokenizer.from_pretrained(self.args.modelsize, model_max_length=512)
    ...
    def main(self, file_name):
        ...
        data = self.data_to_dataT5(graph, self.tokenizer, label, label_to_index, self.args.graph_representation, self.args.eos_usage)
